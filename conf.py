...
BLOG_AUTHOR = "Mike Zamansky"  # (translatable)
BLOG_TITLE = "C'est la Z"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://cestlaz.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://bare.site/"
BLOG_EMAIL = "zamansky@gmail.com"
BLOG_DESCRIPTION = "C'est la Z"  # (translatable)
